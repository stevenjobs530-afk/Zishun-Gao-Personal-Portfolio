...
const glassButtonVariants = cva(
  "relative isolate inline-flex items-center justify-center gap-2 rounded-full cursor-pointer transition-transform duration-300 ease-[cubic-bezier(0.22,1,0.36,1)] tracking-normal active:scale-[0.97] active:duration-150 disabled:opacity-50 disabled:cursor-not-allowed focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-foreground/50 motion-reduce:transition-none",
  {
    variants: {
      size: {
...
const GlassButton = React.forwardRef<HTMLButtonElement, GlassButtonProps>(
  ({ className, children, size, asChild = false, contentClassName, glassColor, liquid = false, ...props }, ref) => {
    ...
    const rootElement = asChild ? (
      ...
      <button type="button" className={rootClassName} ref={ref} {...props}>
