...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    conclusion: [
      "In this project, I translated an applied research question into a clear problem framework, questionnaire routing logic and a working prototype without presenting exploratory work as final findings.",
      "I used the public version to demonstrate research design and ethical judgement while keeping internal research materials appropriately protected.",
      "The resulting prototype provides a complete, discussion-ready summary of the research purpose, method and boundaries.",
    ],
...
const chineseCaseStudies: CaseStudy[] = [
  {
    ...
    conclusion: [
      "在这个项目中，我完成了从混乱运营数据、清洗后的分析表到报告图表的完整分析链路。",
      "我通过 SQL 验证和可复现的清洗逻辑确保数据可靠，并将分析结果转化为便于业务沟通的图表。",
      "这套完整工作流体现了我在 ETL、数据验证与报告呈现方面的实践能力。",
    ],
    href: "https://github.com/stevenjobs530-afk/UK-Retail-Sales-ETL-SQL-Analysis",
  ...
  },
  {
    ...
    conclusion: [
      "在这个项目中，我用 SQL 和 Python 处理了 120 万级记录，建立了一套可复现的工作流，而不是依赖手工表格检查。",
      "我将数据清洗、验证、派生字段、分组分析与可视化表达整合在同一套端到端流程中。",
      "对于不确定记录，我保留问题标记和处理记录，不做静默覆盖，从而保持分析口径透明、审慎。",
    ],
    href: "https://github.com/stevenjobs530-afk/Apple-App-Store-Data-Cleaning-Analysis",
    linkLabel: "打开 GitHub 项目",
  },
  {
    ...
    conclusion: [
      "在这个项目中，我将应用型研究问题转化为清晰的问题框架、问卷分支逻辑与可操作的原型流程，同时不把阶段性探索包装成最终结论。",
      "我通过公开版本呈现研究设计与伦理判断，并妥善保护未公开的研究材料。",
      "最终形成的原型能够完整说明研究目的、方法与边界，可直接用于讨论和评审。",
    ],
    href: "https://stevenjobs530-afk.github.io/Zishun-Gao-Personal-Portfolio/aep-questionnaire-v6-preview/",
    linkLabel: "打开原型预览",
  },
